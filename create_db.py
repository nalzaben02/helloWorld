...
with app.app_context():
    ...
    users = [
        ...
        {'username': 'nalzaben', 'email': 'nalzaben@terpmail.umd.edu', 'first_name': 'Nareena', 'last_name': 'Alzaben',
         'password': generate_password_hash('nalzaben', method='pbkdf2:sha256'), 'role': 'STUDENT'},
    ]
